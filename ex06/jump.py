...
class Kururu_Game:
    def __init__(self):
        ...
        # 画像のロード
        Kururu.right_image = load_image("tori.png")   # 左向き
        ...
        Shot.image = load_image("tama.png")    # add
        Enemy.image = load_image("teki.png", -1) # add               # 左向き
        
        # マップのロード
        self.map = Map("test2.map")
